...
import app.web.thebig6.appstore.databinding.ActivityHelpBinding;
...
public class HelpActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        app.web.thebig6.appstore.databinding.ActivityHelpBinding binding = ActivityHelpBinding.inflate(getLayoutInflater());
